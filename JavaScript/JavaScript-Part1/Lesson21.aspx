<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lesson21.aspx.cs" Inherits="JavaScript_Part1.Lesson21" %>
...
<head runat="server">
    <title>Lesson - 21: Timing Event in JS 2</title>

</head>
<body>
    <h2>SetTimeout Method</h2>
    <p>This program mainly focuses on making the timer and clock using the setTimeout method.</p>
    <div id="Container">
    ...
    <script type="text/javascript">
        ...
        function startClock() {
            ...
            document.getElementById('divClock').innerHTML = new Date();
            IntervalForCLock = setTimeout(startClock, 1000);
        }

        function stopClock() {
            clearTimeout(IntervalForCLock);
        }
        ...
        function startTimer() {
            ...
            IntervalForTImer = setTimeout(startTimer, 1000);
            //this goes on to demonstrate that the setInterval needs to be called recursively.
        }
